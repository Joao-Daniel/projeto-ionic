...
import { IonReorderGroup, ItemReorderEventDetail, PopoverController } from '@ionic/angular';
...
export class ListagemPage   {
  ...
  addFilmesAss(filme:any){}
  removeFilmesAss(filme:any){}

  maskSinopse(sinopse:String, numberChars:number){
    return sinopse.substring(0, numberChars)+"..."
  }

  showSinopse(event:any, sinopse:String){
